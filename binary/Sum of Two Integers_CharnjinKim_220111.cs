...
namespace SumofTwoIntegers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(su.GetSum(6,3));
            Console.WriteLine(su.GetSum(1,4));
            Console.WriteLine(su.GetSum(-1,3));
            Console.WriteLine(su.GetSum(-1,-2));
            Console.WriteLine(su.GetSum(6,-3));
            Console.WriteLine(su.GetSum(-6,-62));
